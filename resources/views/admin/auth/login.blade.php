    ...
    <div class="card-body">
      <div class="row">
        <div class="col-12 text-center"><a href="{{ route('home') }}" class="logo logo-admin">
            <img src="{{ asset('assets/admin/images/3d.png') }}" height="100" alt="logo">
          </a></div>
      </div>
        ...
        <form class="form-horizontal" action="{{ route('login')}}" method="post">
          ...
          <div class="form-group">
            ...
            <div class="d-flex">
              ...
              <span class="mt-1 " style="margin-left: -22px"><i class="fa fa-duotone fa-envelope icon login-icon"></i></span>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="d-flex">
              ...
              <span class="mt-1 " style="margin-left: -22px"><i class="fa fa-regular fa-key icon login-icon"></i></span>
            </div>
