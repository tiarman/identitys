...
<head>
  ...
  <meta content="Team RED Heaker" name="author"/>
      ...
      <div class="text-center" style="padding-right: 35px">
        <a href="{{ route('home') }}" class="logo">
          <img style="background: whitesmoke;display: unset"
               src="{{ asset($company_logo??'assets/admin/images/mat.png') }}" height="50" alt="logo"></a>
      </div>
    </div>
    <div class="sidebar-inner slimscrollleft">
      <div id="sidebar-menu">
        <ul>
          ...
          @if(\App\Helper\CustomHelper::canView('Create Role|Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
            <li class="has_sub">
              <a class="waves-effect"><i class="mdi mdi-account-multiple"></i><span>Visa Query <span
                    class="pull-right"><i class="mdi mdi-chevron-right"></i></span> </span></a>
              <ul class="list-unstyled">
                @if(\App\Helper\CustomHelper::canView('Create Role', 'Super Admin'))
                  <li><a href="{{ route('identity.create') }}">Input Data</a></li>
                @endif
                @if(\App\Helper\CustomHelper::canView('Manage Role|Delete Role|View Role|List Of Role', 'Super Admin'))
                  <li><a href="{{ route('identity.list') }}">List of data</a></li>
                @endif
              </ul>
            </li>
          @endif
  ...
  <div class="content-page">
          ...
          <ul class="float-right mb-0 list-inline">
            ...
            <li class="list-inline-item dropdown notification-list">
              <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#"
                ...
                <img src="{{ auth()->user()->profile_photo_url }}" alt="user" class="object-cover w-8 h-8 rounded-full">
              </a>
    ...
    <footer class="footer">
      ...
      <span class="text-muted hidden-xs-down pull-right">Developed & Maintained by  <a href="https://nrast.com/"
                                                                                                      target="_blank">Black Termux Hacker</a></span>
    </footer>
  </div>
</div>
